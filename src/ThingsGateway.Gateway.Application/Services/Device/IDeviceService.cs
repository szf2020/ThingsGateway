...
internal interface IDeviceService
{
    ...
    Task DeleteByChannelIdAsync(IEnumerable<long> ids, ISqlOrmClient db);
    ...
    Task<List<Device>> GetFromDBAsync(Expression<Func<Device, bool>> expression = null, ISqlOrmClient db = null);

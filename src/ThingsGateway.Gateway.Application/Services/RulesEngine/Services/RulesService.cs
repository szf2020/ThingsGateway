...
.ExecuteCommandAsync().ConfigureAwait(false);
    ...
    /// </summary>
    /// <returns>列表</returns>
    public async Task<List<TResult>> GetFromDBAsync<TResult>(Expression<Func<Rules, TResult>> slct, Expression<Func<Rules, bool>> expression = null, ISqlClient db = null)
    {
        db ??= GetDB();

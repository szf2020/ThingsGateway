...
public static class BusinessDatabaseUtil
{
    ...
    /// </summary>
    public static async Task<OperResult<SqlSugarPagedList<IDBHistoryAlarm>>> GetDBHistoryAlarmPagesAsync(long deviceId, DBHistoryAlarmPageInput input)
    {
        try
        {
    ...
    /// </summary>
    public static async Task<OperResult<SqlSugarPagedList<IDBHistoryValue>>> GetDBHistoryValuePagesAsync(long deviceId, DBHistoryValuePageInput input)
    {
        try
        {
            var driver = GlobalData.IdDevices.TryGetValue(deviceId, out var businessDevice) ? businessDevice.Driver : null;

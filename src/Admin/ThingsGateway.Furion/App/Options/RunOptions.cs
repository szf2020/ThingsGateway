...
public sealed class RunOptions : IRunOptions
{
    ...
    /// <param name="configureAction"></param>
    /// <returns><see cref="RunOptions"/></returns>
    public RunOptions ConfigureFirstActionBuilder(Action<WebApplicationBuilder> configureAction)
    {
    ...
    /// </summary>
    internal Action<WebApplicationBuilder> FirstActionBuilder { get; set; }

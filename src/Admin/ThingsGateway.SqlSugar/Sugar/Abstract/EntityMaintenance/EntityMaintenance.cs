...
namespace ThingsGateway.SqlSugar
{
    public class EntityMaintenance
    {
        ...
        public EntityInfo GetEntityInfoNoCache(Type type)
        {
            ...
            if (this.Context.CurrentConnectionConfig.ConfigureExternalServices?.EntityNameService != null)
            {
        ...
        private void SetColumns(EntityInfo result)
        {
            foreach (var property in result.Type.GetProperties())
            {
                ...
                if (this.Context.CurrentConnectionConfig.ConfigureExternalServices?.EntityService != null)
                {
                ...
                if (column.DataType == null && property?.PropertyType.Name.IsIn("TimeOnly") == true)
                {
                    column.DataType = "time";
                }
                if (column.DataType == null && property?.PropertyType.Name.IsIn("DateOnly") == true)
                {

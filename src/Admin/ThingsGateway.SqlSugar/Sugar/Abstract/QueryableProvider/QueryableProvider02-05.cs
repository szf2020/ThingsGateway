...
namespace SqlSugar
{
    ...
    public partial class QueryableProvider<T, T2> : QueryableProvider<T>, ISugarQueryable<T, T2>
    {
        ...
        {
            var queryable = this.Context.Queryable<T, T2>((t, t2) => Array.Empty<object>()).WithCacheIF(IsCache, CacheTime);
    ...
    public partial class QueryableProvider<T, T2, T3> : QueryableProvider<T>, ISugarQueryable<T, T2, T3>
    {
        ...
        {
            var queryable = this.Context.Queryable<T, T2, T3>((t, t2, t3) => Array.Empty<object>()).WithCacheIF(IsCache, CacheTime);
            base.CopyQueryBuilder(queryable.QueryBuilder);
            return queryable;
        }
    ...
    public partial class QueryableProvider<T, T2, T3, T4> : QueryableProvider<T>, ISugarQueryable<T, T2, T3, T4>
    {
        ...
        {
            var queryable = this.Context.Queryable<T, T2, T3, T4>((t, t2, t3, t4) => Array.Empty<object>()).WithCacheIF(IsCache, CacheTime);
            base.CopyQueryBuilder(queryable.QueryBuilder);
            return queryable;
        }
    ...
    public partial class QueryableProvider<T, T2, T3, T4, T5> : QueryableProvider<T>, ISugarQueryable<T, T2, T3, T4, T5>
    {
        ...
        {
            var queryable = this.Context.Queryable<T, T2, T3, T4, T5>((t, t2, t3, t4, t5) => Array.Empty<object>()).WithCacheIF(IsCache, CacheTime);
            base.CopyQueryBuilder(queryable.QueryBuilder);
            return queryable;
        }

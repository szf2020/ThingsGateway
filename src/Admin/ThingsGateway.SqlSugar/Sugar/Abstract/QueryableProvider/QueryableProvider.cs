...
namespace ThingsGateway.SqlSugar
{
    ...
    public partial class QueryableProvider<T> : QueryableAccessory, ISugarQueryable<T>
    {
        ...
        public ISugarQueryable<T> CrossQuery(Type type, string configId)
        {
            ...
            QueryBuilder.CrossQueryItems.TryAdd(type.FullName, configId);
            return this;
        }
        ...
        public virtual ISugarQueryable<TResult> Select<TResult>()
        {
            ...
            else if (this.QueryBuilder.EntityType == UtilConstants.ObjType || (this.QueryBuilder.AsTables?.Count == 1) || this.QueryBuilder.EntityName != this.QueryBuilder.EntityType.Name)
            {
        ...
        public ISugarQueryable<T> SplitTable(Func<List<SplitTableInfo>, IEnumerable<SplitTableInfo>> getTableNamesFunc)
        {
            ...
            else
            {
                ...
                if (unionall.QueryBuilder.Includes?.Count > 0)
                {

...
namespace ThingsGateway.SqlSugar
{
    public partial class SqlSugarScope : ISqlSugarClient, ITenant
    {
        ...
        {
            await ScopedContext.BeginTranAsync(iso).ConfigureAwait(false);
        }
        ...
        public IDeleteable<T> DeleteableWithAttr<T>(IReadOnlyCollection<T> deleteObjs) where T : class, new()
        {

...
namespace SqlSugar
{
    ...
    public partial class ContextMethods : IContextMethods
    {
        ...
        {
            return item.Type == JTokenType.Object || fileName.Contains("SqlFunc_", StringComparison.CurrentCultureIgnoreCase);
        }
        ...
        {
            return item.ObjToString().Contains("fieldname", StringComparison.CurrentCultureIgnoreCase);
        }

...
namespace SqlSugar
{
    public class SubWhere : ISubOperation
    {
        ...
        public string GetValue(Expression expression)
        {
            ...
            if (argExp.Type == typeof(List<IConditionalModel>) && this.Context.Parameters.Count != 0)
            {
            ...
            else if (argExp.Type == typeof(List<IConditionalModel>) && this.Context.Parameters.Count == 0)
            {

    ...
    public partial class BaseResolve
    {
        ...
        private void AppendMember(ExpressionParameter parameter, bool? isLeft, object value, Expression oppoSiteExpression)
        {
            ...
            else if (value.ObjToString() != "NULL" && !parameter.ValueIsNull)
            {
                ...
                if (columnInfo?.SqlParameterDbType != null && columnInfo.SqlParameterDbType is System.Data.DbType)
                {
                ...
                {
                    this.Context.Parameters.Add(new SugarParameter(appendValue, DefaultServices.Serialize.SerializeObject(value)) { IsJson = true });
                }

    ...
    public class SqliteUpdateBuilder : UpdateBuilder
    {
        ...
        protected override string TomultipleSqlString(List<IGrouping<int, DbColumnInfo>> groupList)
        {
            ...
            sb.AppendLine(string.Join("\r\n", groupList.Select(t =>
            {
                ...
                var setValues = string.Join(",", t.Where(s => !s.IsPrimarykey).Where(s => OldPrimaryKeys?.Contains(s.DbColumnName) != true).Select(m => GetOracleUpdateColums(i, m, false)).ToArray());
